...
import img1 from "./image/about1.jpg"
import img2 from "./image/about2.jpg";
import img3 from "./image/about3.jpg";
import img4 from "./image/about4.jpg";
    ...
    return (
        ...
        <>
            <Common
                ...
                Anaesthesiologists also provide pre-operative assessments, ensuring the patient
                 is safe during the operation and successfully "
                visit="/service"
                btname="Get Started" 
                img1={img1}
                img2={img2}
                content2="Emergency room doctors are in charge of sudden important or life-threatening
                 ...
                 issues that require immediate medical attention or surgeries, they also deal with a
                  wide range of other health conditions"
                ...
                training is diverse to deal with a variety of conditions including all non surgical 
                specialties. "
                img2={img4}
